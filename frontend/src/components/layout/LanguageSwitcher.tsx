  ...
  if (code === 'tr') {
    return (
      <svg viewBox="0 0 12 8" className={className} aria-hidden>
        ...
        <polygon fill="#fff" points="6.55,2.7 6.95,3.55 7.9,3.55 7.15,4.1 7.45,4.95 6.55,4.4 5.65,4.95 5.95,4.1 5.2,3.55 6.15,3.55" />
      </svg>
    );
  }
  if (code === 'pt') {
  ...
  if (code === 'zh') {
    return (
      <svg viewBox="0 0 12 8" className={className} aria-hidden>
        ...
        <polygon fill="#FFDE00" points="2.4,1.35 2.7,2.25 3.65,2.25 2.88,2.8 3.18,3.7 2.4,3.15 1.62,3.7 1.92,2.8 1.15,2.25 2.1,2.25" />
      </svg>
    );
  }
  if (code === 'ja') {
